    ...
    <section id="compliance" className="bg-[#e8866a]">
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="px-10 md:px-16 pt-14 pb-10">
          ...
          <p className="font-serif text-xl md:text-2xl text-white/90 mb-5">
            Compliance is built into everything we do.
          </p>
          <div className="border-t border-white/30 mb-6 w-full max-w-md" />

          <ul className="space-y-4 mb-6 max-w-md">
            {[
          ...
          <blockquote>
            ...
            <p className="font-serif italic text-base text-white/90 leading-relaxed mb-1 max-w-md">
        ...
        {/* Right — image, height locked to left content */}
